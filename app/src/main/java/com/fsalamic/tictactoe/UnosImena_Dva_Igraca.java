...
public class UnosImena_Dva_Igraca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unosi_imena_dva_igraca);
    ...
    public void SubmitDugmeKlik(View view) {
        ...
        Intent intent = new Intent(this, DualPlayer_Igra.class);
